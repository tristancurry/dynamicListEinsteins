...
int balloonLimit = 4;   //how many balloons should be allowed to exist simultaneously? Usually a good idea to set something up like this.
...
void mouseClicked(){          //do this stuff when the mouse is clicked
   ...
   if(balloonList.size() < balloonLimit){  //if there aren't already too many balloons around...
     NumberedBalloon newBalloon = new NumberedBalloon(mouseX, mouseY, random(-3,3), random(-3,3));  //declare and create a new balloon, with random properties
